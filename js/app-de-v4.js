...
const translations = {
    ...
    'aluminiumchlorid': 'Aluminum Chloride', 'bariumchlorid': 'Barium Chloride',
...
const materialInfo = {
    ...
    "PVC_HART": { name: "PVC hart", full: "Hart-PVC (weichmacherfrei)", type: "Thermoplast" },
    "PVC_WEICH": { name: "PVC weich", full: "Weich-PVC (weichmacherhaltig)", type: "Thermoplast" },
